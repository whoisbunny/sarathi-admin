...
import { updateCoupon, deleteCoupon, toggleEditModal } from "@/store/coupon/coupon.reducer";
...
const CouponList = ({ coupons }) => {
  ...
  const actions = [
    ...
    //   doit: (item) => navigate(`/coupon/${item._id}`),
    // },
    {
      name: "edit",
      icon: "heroicons:pencil-square",
      doit: (item) => {
        dispatch(updateCoupon(item));
    ...
    },
    {
      ...
      doit: (item) => dispatch(deleteCoupon(item._id)),
    },
  ];
