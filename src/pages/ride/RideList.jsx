...
import { updateRide } from "../../store/ride/ride.reducer";
...
const RideList = ({ rides }) => {
  ...
  const actions = [
    {
      ...
      doit: (item) => navigate(`/ride/${item._id}`),
    },
    {
      name: "edit",
      icon: "heroicons:pencil-square",
      doit: (item) => dispatch(updateRide(item)),
    },
    {
      name: "delete",
  ...
  const data = useMemo(() => rides, [rides]);
    ...
    <>
      <Card noborder>
        <div className="md:flex justify-between items-center mb-6">
          <h4 className="card-title">Rides List</h4>
        </div>
