...
const UsersPostPage = lazy(() => import("./pages/users"));
const CaptainPostPage = lazy(() => import("./pages/captain"));
    ...
    <main className="App  relative">
      <Routes>
        ...
        <Route path="/*" element={<Layout />}>
          ...
          <Route path="dashboard" index element={<CrmPage />} />
          ...
          {/* project routes */}
          <Route path="user" element={<UsersPostPage />} />
